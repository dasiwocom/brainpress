...
| `assets/` | 本地库（marked、DOMPurify、highlight.js、pdf.js、React + @excalidraw/excalidraw、字体），无 CDN |
...
| `assets/` | Local libraries (marked, DOMPurify, highlight.js, pdf.js, React + @excalidraw/excalidraw, fonts) – no CDN |
